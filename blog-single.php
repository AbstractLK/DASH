...
?>
        ...
        <!-- Page title -->
        <section id="page-title" class="page-title-center text-light" style="background-image:url(images/parallax/2.jpg);">
            <div class="bg-overlay"></div>
            <div class="container">
                <div class="page-title">
                    <span class="post-meta-category"><a href="">News</a></span>
                    <h1>Creative post with a single image</h1>
                    <div class="small m-b-20">May 16, 2023 | <a href="#">by admin</a> | <a href="#">3 Comments</a> </div>
